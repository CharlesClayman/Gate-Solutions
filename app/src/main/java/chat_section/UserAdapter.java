...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        FirebaseDatabase.getInstance().getReference().child("users").child(user.id).child("profileImageUrl").addValueEventListener(
                new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists())
                        {
                            Glide.with(mContext).load(dataSnapshot.getValue()).into(holder.profile_image);
                        }
                    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            img_online = itemView.findViewById(R.id.img_on);
